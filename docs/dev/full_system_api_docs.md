...
*   **API Endpoint:** `PUT /api/TheaterManager/Shifts/staff-profiles/{id}` (với `{id}` là `UserId` của nhân viên)
...
*   **API Endpoint:** `POST /api/Staff/Shifts/register`
*   **Quyền:** Yêu cầu đăng nhập (JWT)
*   **Request Body:**
    ```json
    {
...
*   **API Endpoint:** `POST /api/Staff/Shifts/{staffId}/register-face`
...
*   **API Endpoint:** `POST /api/Staff/Shifts/clock-in`
...
*   **API Endpoint:** `POST /api/Staff/Shifts/clock-out`
...
*   **API Endpoint:** `POST /api/TheaterManager/Shifts/templates`
...
*   **API Endpoint:** `POST /api/TheaterManager/Shifts/registrations/{id}/approve` (với `{id}` là `ShiftRegistrationId` của bản ghi đăng ký)
*   **Quyền:** TheaterManager, Admin
*   **Request Body:**
    ```json
    {
...
*   **API Endpoint:** `POST /api/TheaterManager/Shifts/registrations/{id}/reject`
*   **Quyền:** TheaterManager, Admin
*   **Request Body:**
    ```json
    {
...
*   **API Endpoint:** `POST /api/TheaterManager/Shifts/payroll/calculate`
*   **Quyền:** TheaterManager, Admin
*   **Request Body:**
    ```json
    {
...
*   **API Endpoint:** `POST /api/TheaterManager/Shifts/payroll/{id}/pay` (với `{id}` là `salaryTotalLoggerId` nhận được từ bước tính lương)
*   **Quyền:** TheaterManager, Admin
*   **Response Body:**
    ```json
    {
