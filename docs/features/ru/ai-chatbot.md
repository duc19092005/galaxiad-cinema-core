...
> Интеллектуальный виртуальный помощник на базе Claude Opus. Глобальный компонент на всех страницах.
...
> [!NOTE]
> LLM (Claude Opus) **никогда не создаёт расписание напрямую**. Backend владеет: авторизацией, SQL, векторным поиском, обрезкой данных, фильтрацией. LLM только: классифицирует намерение, пишет объяснение.
