...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260619065451_AddPricingPromotions")]
    partial class AddPricingPromotions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLayer.Entities.CinemaInfos.DepartmentEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.MovieInfos.MovieCommentEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.MovieInfos.MovieViewEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.Promotions.HolidayCalendarEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.Promotions.PricingPromotionEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.Promotions.PricingPromotionRuleEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.UserInfos.UserGenreSurveyEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.UserInfos.UserNotificationEntity", b =>
                {
            ...
            modelBuilder.Entity("BusinessLayer.Entities.CinemaInfos.DepartmentEntity", b =>
                {
                    ...
                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "SharedUserInfoEntity")
                        .WithOne()
                        .HasForeignKey("BusinessLayer.Entities.CinemaInfos.DepartmentEntity", "SharedUserId")
                        .OnDelete(DeleteBehavior.Restrict);
            ...
            modelBuilder.Entity("BusinessLayer.Entities.MovieInfos.MovieCommentEntity", b =>
                {
                    ...
                    b.HasOne("BusinessLayer.Entities.MovieInfos.MovieCommentEntity", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("BusinessLayer.Entities.Promotions.PricingPromotionEntity", b =>
                {
                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "CreatedByUser")
                        .WithMany()
                        .HasForeignKey("CreatedBy")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "UpdatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entities.Promotions.PricingPromotionRuleEntity", b =>
                {
                    b.HasOne("BusinessLayer.Entities.CinemaInfos.AuditoriumInfoEntities", "AuditoriumInfoEntity")
                        .WithMany()
                        .HasForeignKey("AuditoriumId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("BusinessLayer.Entities.Promotions.PricingPromotionEntity", "PricingPromotionEntity")
                        .WithMany("Rules")
                        .HasForeignKey("PricingPromotionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BusinessLayer.Entities.UserInfos.UserSegmentsInfoEntity", "RequiredMembershipTierEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entities.UserInfos.StaffProfileEntity", b =>
                {
                    ...
                    b.HasOne("BusinessLayer.Entities.CinemaInfos.DepartmentEntity", "DepartmentEntity")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entities.UserInfos.UserNotificationEntity", b =>
                {
                    b.HasOne("BusinessLayer.Entities.MovieInfos.MovieCommentEntity", "RelatedComment")
                        .WithMany()
                        .HasForeignKey("RelatedCommentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("BusinessLayer.Entities.MovieInfos.MovieInfoEntity", "RelatedMovie")
                        .WithMany()
