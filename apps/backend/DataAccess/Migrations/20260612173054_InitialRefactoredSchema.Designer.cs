...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260612173054_InitialRefactoredSchema")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BusinessLayer.Entities.CinemaInfos.AuditoriumInfoEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8106)
                        },
                        new
                        {
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8110)
                        },
                        new
                        {
                            AuditoriumId = new Guid("55555555-5555-5555-5555-555555555555"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8113)
                        });
                });
            ...
            modelBuilder.Entity("BusinessLayer.Entities.CinemaInfos.CinemaInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8031)
                        },
                        new
                        {
                            CinemaId = new Guid("22222222-2222-2222-2222-222222222222"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8049)
                        },
                        new
                        {
                            CinemaId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(8054)
                        });
                });
            ...
            modelBuilder.Entity("BusinessLayer.Entities.MovieInfos.MovieInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9077)
                        },
                        new
                        {
                            MovieId = new Guid("77777777-7777-7777-7777-777777777777"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9108)
                        },
                        new
                        {
                            MovieId = new Guid("88888888-8888-8888-8888-888888888888"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9113)
                        });
                });
            ...
            modelBuilder.Entity("BusinessLayer.Entities.MovieInfos.MovieScheduleInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MovieScheduleInfoId = new Guid("73ee35f5-5f22-4966-9fb5-ce7309a219b5"),
                            ActiveAt = new DateTime(2026, 3, 19, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9253),
                            CreatedByUserId = new Guid("7b5d2c1e-9f8a-3e7b-c1d2-a0e9f8c7b6a5"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9254)
                        },
                        new
                        {
                            MovieScheduleInfoId = new Guid("897adf24-f3b0-4d38-bbbe-32b8832f360d"),
                            ActiveAt = new DateTime(2026, 3, 19, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9354),
                            CreatedByUserId = new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 13, 0, 30, 51, 23, DateTimeKind.Local).AddTicks(9355)
                        });
                });
            ...
            modelBuilder.Entity("BusinessLayer.Entities.UserInfos.PermissionForRoleEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            PermissionId = new Guid("a1b2c3d4-1111-1111-1111-111111111009"),
                            RoleId = new Guid("8b3d6f7e-9c0a-4b1d-2e3f-4a5b6c7d8e9f")
                        },
                        new
                        {
                            PermissionId = new Guid("a1b2c3d4-1111-1111-1111-111111111011"),
                        ...
                        {
                            PermissionId = new Guid("a1b2c3d4-1111-1111-1111-111111111009"),
                            RoleId = new Guid("9c4e7f8a-0d1b-4c2d-3e4f-5a6b7c8d9e0f")
                        },
                        new
                        {
                            PermissionId = new Guid("a1b2c3d4-1111-1111-1111-111111111011"),
            ...
            modelBuilder.Entity("BusinessLayer.Entities.AuditLogs.AuditLogEntity", b =>
                {
                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "Actor")
                        .WithMany()
            ...
            modelBuilder.Entity("BusinessLayer.Entities.CinemaInfos.AuditoriumInfoEntities", b =>
                {
                    ...
                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "Creator")
                        .WithMany("CreatedAuditoriums")
                        .HasForeignKey("CreatedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "Deleter")
                    ...
                    b.HasOne("BusinessLayer.Entities.UserInfos.UserInfoEntity", "Updater")
