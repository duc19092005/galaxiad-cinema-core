...
const samples = [
  {
    ...
    licenseStartAt: '2026-09-06',
    licenseEndAt: '2027-09-20',
  ...
  {
    file: 'sample-contracts/hop_dong_chieu_phim_avatar_dong_chay_cua_nuoc.pdf',
    contractCode: 'HDCP/2026/GLX-003',
    distributorName: 'Cong ty TNHH Phat Hanh Phim Blue Moon',
    distributorRepresentative: 'Pham Minh Anh',
    cinemaName: 'Cong ty Co phan Cum Rap Chieu Phim Galaxiad Cinema',
    cinemaRepresentative: 'Tran Thi Thu Thao',
    vietnameseTitle: 'AVATAR: DÒNG CHẢY CỦA NƯỚC',
    description: 'Jake Sully va gia dinh tim cach bao ve nhau truoc nhung moi de doa moi tren hanh tinh Pandora.',
    ...
    licenseStartAt: '2026-09-06',
    licenseEndAt: '2027-09-20',
    cinemaScope: 'Galaxy Cinema Nguyễn Du và Lotte Cinema West Lake; không cấp cho rạp khác.',
    formats: '2D, 3D, IMAX',
    cinemaSharePercent: 48,
    distributorSharePercent: 52,
    revenueBasis: 'TICKET_FINAL_PRICE_AFTER_REFUND',
    settlementCycle: 'MONTHLY'
  },
  {
    file: 'sample-contracts/hop_dong_chieu_phim_oppenheimer.pdf',
    contractCode: 'HDCP/2026/GLX-004',
    distributorName: 'Universal Pictures Vietnam',
    distributorRepresentative: 'Nguyen Quoc Bao',
    cinemaName: 'Cong ty Co phan Cum Rap Chieu Phim Galaxiad Cinema',
    cinemaRepresentative: 'Tran Thi Thu Thao',
    vietnameseTitle: 'OPPENHEIMER',
    description: 'Cau chuyen ve nha vat ly J. Robert Oppenheimer va vai tro cua ong trong viec phat trien bom nguyen tu.',
    ...
    licenseStartAt: '2026-09-06',
    licenseEndAt: '2027-09-20',
    cinemaScope: 'Toan bo he thong Galaxiad Cinema tai Viet Nam; khong gioi han rap cu the.',
    formats: '2D, IMAX, Dolby Atmos',
    cinemaSharePercent: 52,
    distributorSharePercent: 48,
    revenueBasis: 'TICKET_FINAL_PRICE_AFTER_REFUND',
    settlementCycle: 'WEEKLY'
  },
  {
    file: 'sample-contracts/hop_dong_chieu_phim_spider_man_spider_verse.pdf',
    contractCode: 'HDCP/2026/GLX-005',
    distributorName: 'Sony Pictures Releasing Vietnam',
    distributorRepresentative: 'Le Thu Ha',
    cinemaName: 'Cong ty Co phan Cum Rap Chieu Phim Galaxiad Cinema',
    cinemaRepresentative: 'Tran Thi Thu Thao',
    vietnameseTitle: 'SPIDER-MAN: DU HÀNH VŨ TRỤ NHỆN',
    description: 'Miles Morales buoc vao hanh trinh xuyen cac vu tru va gap nhung Spider-Man moi.',
    ...
    licenseStartAt: '2026-09-06',
    licenseEndAt: '2027-09-20',
    cinemaScope: 'Chi BHD Star Bitexco; pham vi nay khong mo rong sang rap khac.',
    formats: '2D, 3D',
    cinemaSharePercent: 47,
    distributorSharePercent: 53,
    revenueBasis: 'TICKET_FINAL_PRICE_AFTER_REFUND',
    settlementCycle: 'MONTHLY'
  }
];
