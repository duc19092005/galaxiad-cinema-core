...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260405061026_UpdateRefreshTokenColumnLength")]
    partial class UpdateRefreshTokenColumnLength
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.AuditoriumInfoEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1282)
                        },
                        new
                        {
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1287)
                        },
                        new
                        {
                            AuditoriumId = new Guid("55555555-5555-5555-5555-555555555555"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1290)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.CinemaInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1204)
                        },
                        new
                        {
                            CinemaId = new Guid("22222222-2222-2222-2222-222222222222"),
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1210)
                        },
                        new
                        {
                            CinemaId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(1215)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2490)
                        },
                        new
                        {
                            MovieId = new Guid("77777777-7777-7777-7777-777777777777"),
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2520)
                        },
                        new
                        {
                            MovieId = new Guid("88888888-8888-8888-8888-888888888888"),
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2524)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieScheduleInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MovieScheduleInfoId = new Guid("32a9ef22-5211-4641-a024-7deab5cf520b"),
                            ActiveAt = new DateTime(2026, 3, 19, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2686),
                            CreatedByUserId = new Guid("7b5d2c1e-9f8a-3e7b-c1d2-a0e9f8c7b6a5"),
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2687)
                        },
                        new
                        {
                            MovieScheduleInfoId = new Guid("aa3a1cc3-a6d6-49ad-ba0c-1b382e6ed5c5"),
                            ActiveAt = new DateTime(2026, 3, 19, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2718),
                            CreatedByUserId = new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"),
                            ...
                            UpdatedAt = new DateTime(2026, 4, 5, 13, 10, 25, 63, DateTimeKind.Local).AddTicks(2719)
                        });
                });
