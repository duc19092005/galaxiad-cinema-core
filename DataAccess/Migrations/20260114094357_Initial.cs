    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movie_genre_info_entity", x => x.movieGenreId);
                });

            migrationBuilder.CreateTable(
                name: "movie_required_age_entity",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movie_required_age_entity", x => x.movieRequiredAgeId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    movie_required_age_entitymovieRequiredAgeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    isDeleted = table.Column<bool>(type: "bit", nullable: false),
                    isActive = table.Column<bool>(type: "bit", nullable: false),
                    deletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    activeAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movie_info_entity", x => x.movieId);
                    table.ForeignKey(
                        name: "FK_movie_info_entity_movie_required_age_entity_movie_required_age_entitymovieRequiredAgeId",
                        column: x => x.movie_required_age_entitymovieRequiredAgeId,
                        principalTable: "movie_required_age_entity",
                        principalColumn: "movieRequiredAgeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_movie_info_entity_user_info_entity_createdByUserId",
                        column: x => x.createdByUserId,
                        principalTable: "user_info_entity",
                        principalColumn: "userId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_movie_info_entity_user_info_entity_deletedByUserId",
                        column: x => x.deletedByUserId,
                        principalTable: "user_info_entity",
                        principalColumn: "userId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_movie_info_entity_user_info_entity_managerId",
                        column: x => x.managerId,
                        principalTable: "user_info_entity",
                        principalColumn: "userId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_movie_info_entity_user_info_entity_updatedByUserId",
                        column: x => x.updatedByUserId,
                        principalTable: "user_info_entity",
                        principalColumn: "userId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                name: "movie_genre_movie_info_entity",
                columns: table => new
                {
                    movieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    movieGenreId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_movie_genre_movie_info_entity", x => new { x.movieGenreId, x.movieId });
                    table.ForeignKey(
                        name: "FK_movie_genre_movie_info_entity_movie_genre_info_entity_movieGenreId",
                        column: x => x.movieGenreId,
                        principalTable: "movie_genre_info_entity",
                        principalColumn: "movieGenreId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_movie_genre_movie_info_entity_movie_info_entity_movieId",
                        column: x => x.movieId,
                        principalTable: "movie_info_entity",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_movie_schedule_info_entity_movie_info_entity_movieId",
                        column: x => x.movieId,
                        principalTable: "movie_info_entity",
                        principalColumn: "movieId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1c2d3e4f-5a6b-4c7d-8e9f-0a1b2c3d4e5f"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Luxury bed-seating auditorium designed for ultimate comfort and couples.", "L'Amour", 600000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5694), null },
                    { new Guid("3fbc4a32-15f5-47e0-b98a-784f1b8a9612"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Standard digital 2D format with crystal clear image quality.", "2D", 80000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5671), null },
                    { new Guid("5d4c3b2a-1f0e-4d9c-8b7a-6e5d4c3b2a1f"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Multi-sensory experience featuring motion seats, wind, water, and scents.", "4DX", 180000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5690), null },
                    { new Guid("7a5e82b1-c4d3-4a92-9e11-3f4b52c1a8d9"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Immersive three-dimensional visual experience with specialized glasses.", "3D", 110000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5679), null },
                    { new Guid("9f8e7d6c-5b4a-4e3d-2c1b-0a9f8e7d6c5b"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Premium luxury seating with in-theater dining and personalized service.", "Gold Class", 300000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5692), null },
                    { new Guid("a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "A revolutionary 270-degree panoramic cinematic experience.", "ScreenX", 160000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5687), null },
                    { new Guid("d29b0f1c-8e2a-4c5b-bc3d-1a2f3e4d5c6b"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "Giant screen format with unparalleled brightness and ultra-high resolution.", "IMAX", 250000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5682), null },
                    { new Guid("f9e1d2c3-b4a5-4e6f-8d7c-9b0a1f2e3d4c"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"), null, null, true, false, "State-of-the-art surround sound technology for a lifelike audio experience.", "Dolby Atmos", 130000m, new DateTime(2026, 1, 14, 16, 43, 57, 377, DateTimeKind.Local).AddTicks(5685), null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_movie_genre_info_entity_movieGenreDescription",
                table: "movie_genre_info_entity",
                column: "movieGenreDescription",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_genre_info_entity_movieGenreName",
                table: "movie_genre_info_entity",
                column: "movieGenreName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_genre_movie_info_entity_movieId",
                table: "movie_genre_movie_info_entity",
                column: "movieId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_createdByUserId",
                table: "movie_info_entity",
                column: "createdByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_deletedByUserId",
                table: "movie_info_entity",
                column: "deletedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_managerId",
                table: "movie_info_entity",
                column: "managerId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_movie_required_age_entitymovieRequiredAgeId",
                table: "movie_info_entity",
                column: "movie_required_age_entitymovieRequiredAgeId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_movieDescription",
                table: "movie_info_entity",
                column: "movieDescription",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_movieImageUrl",
                table: "movie_info_entity",
                column: "movieImageUrl",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_movieName",
                table: "movie_info_entity",
                column: "movieName",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_info_entity_updatedByUserId",
                table: "movie_info_entity",
                column: "updatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_movie_required_age_entity_movieRequiredAgeDescription",
                table: "movie_required_age_entity",
                column: "movieRequiredAgeDescription",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_movie_required_age_entity_movieRequiredAgeSymbol",
                table: "movie_required_age_entity",
