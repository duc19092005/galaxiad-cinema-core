...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260318030821_add_new_col")]
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.AuditoriumInfoEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3566)
                        },
                        new
                        {
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3569)
                        },
                        new
                        {
                            AuditoriumId = new Guid("55555555-5555-5555-5555-555555555555"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3571)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.CinemaInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3518)
                        },
                        new
                        {
                            CinemaId = new Guid("22222222-2222-2222-2222-222222222222"),
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3523)
                        },
                        new
                        {
                            CinemaId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(3526)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4471)
                        },
                        new
                        {
                            MovieId = new Guid("77777777-7777-7777-7777-777777777777"),
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4500)
                        },
                        new
                        {
                            MovieId = new Guid("88888888-8888-8888-8888-888888888888"),
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4504)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieScheduleInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MovieScheduleInfoId = new Guid("8131e3ed-ebe2-47d9-b5f6-b8411257b950"),
                            ActiveAt = new DateTime(2026, 3, 19, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4579),
                            CreatedByUserId = new Guid("7b5d2c1e-9f8a-3e7b-c1d2-a0e9f8c7b6a5"),
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4580)
                        },
                        new
                        {
                            MovieScheduleInfoId = new Guid("43f2b23d-0d1a-4bf9-827d-d7956151d8ac"),
                            ActiveAt = new DateTime(2026, 3, 19, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4660),
                            CreatedByUserId = new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"),
                            ...
                            UpdatedAt = new DateTime(2026, 3, 18, 10, 8, 19, 611, DateTimeKind.Local).AddTicks(4661)
                        });
                });
