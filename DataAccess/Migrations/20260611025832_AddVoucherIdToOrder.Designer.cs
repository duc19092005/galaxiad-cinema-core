...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260611025832_AddVoucherIdToOrder")]
    partial class AddVoucherIdToOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.AuditoriumInfoEntities", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8668)
                        },
                        new
                        {
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8673)
                        },
                        new
                        {
                            AuditoriumId = new Guid("55555555-5555-5555-5555-555555555555"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8675)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.CinemaInfos.CinemaInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8606)
                        },
                        new
                        {
                            CinemaId = new Guid("22222222-2222-2222-2222-222222222222"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8615)
                        },
                        new
                        {
                            CinemaId = new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"),
                            ...
                            IsActive = true,
                            IsDeleted = false,
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(8618)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9478)
                        },
                        new
                        {
                            MovieId = new Guid("77777777-7777-7777-7777-777777777777"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9506)
                        },
                        new
                        {
                            MovieId = new Guid("88888888-8888-8888-8888-888888888888"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9510)
                        });
                });
            ...
            modelBuilder.Entity("DataAccess.Entities.MovieInfos.MovieScheduleInfoEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MovieScheduleInfoId = new Guid("44c40988-e258-4da8-aa47-32bb86b53baa"),
                            ActiveAt = new DateTime(2026, 3, 19, 19, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("33333333-3333-3333-3333-333333333333"),
                            CreatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9640),
                            CreatedByUserId = new Guid("7b5d2c1e-9f8a-3e7b-c1d2-a0e9f8c7b6a5"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9641)
                        },
                        new
                        {
                            MovieScheduleInfoId = new Guid("c4ec23c8-4751-45a7-b0a6-88f20839f4f0"),
                            ActiveAt = new DateTime(2026, 3, 19, 20, 0, 0, 0, DateTimeKind.Unspecified),
                            AuditoriumId = new Guid("44444444-4444-4444-4444-444444444444"),
                            CreatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9718),
                            CreatedByUserId = new Guid("e4e1f7d8-c3b2-4a90-8c67-2f5a1b3d9e0c"),
                            ...
                            UpdatedAt = new DateTime(2026, 6, 11, 9, 58, 30, 953, DateTimeKind.Local).AddTicks(9718)
                        });
                });
