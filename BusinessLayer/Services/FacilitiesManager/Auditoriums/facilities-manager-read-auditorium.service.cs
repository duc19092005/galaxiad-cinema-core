...
public class facilitiesManagerReadAuditoriumService
{
    ...
    public async BaseResponseponse<List<get_res_auditorium_dto>>> GetAll()
    {
    ...
    public async BaseResponseponse<get_res_auditorium_dto>> GetById(Guid id)
    {
        var objects = _readFactory.ReadData<get_res_auditorium_dto>(write_enum.Auditorium);
    ...
    public async BaseResponseponse<List<GetResAuditoriumDtoCinema>>> GetByCinemaId(Guid cinemaId)
    {
