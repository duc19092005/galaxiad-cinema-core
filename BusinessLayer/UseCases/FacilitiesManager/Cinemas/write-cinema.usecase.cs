...
public class facilitiesManagerWriteCinemaUseCase : IWriteBehavior<add_cinema_req_dto ,edit_cinema_req_dto?, string>
{
    ...
    public async BaseResponseponse<string>> AddItem(add_cinema_req_dto request)
    {
    ...
    public async BaseResponseponse<string>> UpdateItem(Guid itemId, edit_cinema_req_dto request)
    {
    ...
    public async BaseResponseponse<string>> DeleteItem(Guid itemId)
    {
        return null!;
    }
}