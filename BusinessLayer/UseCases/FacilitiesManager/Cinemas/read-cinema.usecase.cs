...
public class facilitiesManagerReadCinemaUseCase : IReadBehavior<res_facilities_manager_cinema>
{
    ...
    public async TBaseResponseonse<List<res_facilities_manager_cinema>>> GetAll()
    {
        try
        {
    ...
    public async TaskBaseResponsee<res_facilities_manager_cinema>> GetById(Guid id)
    {
        try
        {
            ...
            return new basBaseResponses_facilities_manager_cinema>()
            {
                isSuccess = true,
                data = cinemaData,
    ...
    public Task<baBaseResponseist<res_facilities_manager_cinema>>> GetByEntityName(string name)
    {
        return null!;
    }
}